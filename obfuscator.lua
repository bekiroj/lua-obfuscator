...
self.__toByte = function(self,path,data)
    self.data = ''..data..''
	self.byte = ""
	...
	do self.__toRandom(self, path, 'loadstring("'..self.byte..'")();') end
end

self.__toRandom = function(self,path,b)
...
do self.__toRandom(self, value[1], self.data) end